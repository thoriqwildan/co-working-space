...
export class SpaceRepository {
    ...
    async findManyWithPagination(paginationDto: FilterSpaceDto): Promise<PaginationResponseDto<Space>> {
        ...
        if (paginationDto.price_gte || paginationDto.price_lte) {
            filters.push({
                price: {
                    gte: paginationDto.price_gte ? Number(paginationDto.price_gte): undefined,
                    lte: paginationDto.price_lte ? Number(paginationDto.price_lte): undefined
                }
            })
        }
